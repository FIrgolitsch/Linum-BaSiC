...
try:  # pragma: no cover - exercised once tuning.py lands in the stacked PR
    from linum_basic.tuning import _DEFAULT_SEARCH_SPACE  # noqa: F401
...
requires_tuning = pytest.mark.skipif(
    ...
    reason="linum_basic.tuning is added by a later pull request in the chain",
)
